...
public class VegetableAdapter extends RecyclerView.Adapter<VegetableAdapter.VegetableViewHolder> {
    private List<VegetableItemPojo> vegetableList = null;
    ...
    public VegetableAdapter(List<VegetableItemPojo> vegetableList) {
        this.vegetableList = vegetableList;
    }
    public void setData(List<VegetableItemPojo> data) {
    ...
    public void onBindViewHolder(VegetableViewHolder holder, int position){
        VegetableItemPojo currentItem = vegetableList.get(position);
