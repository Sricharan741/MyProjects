...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ExceptionDetails> handleSpecialistNotFoundException(SpecialistNotFoundException ex) {
		log.error("handles by SpecialistNotFoundException");
		ExceptionDetails exceptionDetail = new ExceptionDetails(LocalDateTime.now(), ex.getMessage());
		log.error(ex.getMessage());
		return new ResponseEntity<>(exceptionDetail, HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<ExceptionDetails> handlePackageDetailNotFoundException(PackageDetailNotFoundException ex) {
		log.error("handles by PackageDetailNotFoundException");
		ExceptionDetails exceptionDetail = new ExceptionDetails(LocalDateTime.now(), ex.getMessage());
		log.error(ex.getMessage());
		return new ResponseEntity<>(exceptionDetail, HttpStatus.NOT_FOUND);
	}
