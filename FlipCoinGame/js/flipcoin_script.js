		...
		if(button.value=="Toss" || button.value=="Continue" || button.value=="Toss Again" ){
			...
			if(validation==true)
			{
				...
				if(flipno<=flips && trialno<=10)
				{
					...
					document.getElementById("bet_value").disabled=true;
					...
					if(flipno<flips){
						...
						document.getElementById("statusimage").src="../images/continue.png";
					}
					setTimeout(function(){
						if(flipno==flips){
	...
	//function to add the score into the user wallet
	...
	//function to delete the score from the user wallet
	...
	//function to set the corresponding scores into wallets
	...
	function winnerOrLoser(user_wallet,comp_wallet,trialno)
	{
		if(((user_wallet>comp_wallet)&&trialno==10)||(comp_wallet==0&&trialno<=10)){
			...
			document.getElementById("statusimage").src="../images/tie.png";
			...
			document.getElementById("bet_value").disabled=false;
			setIdValue("b1","Toss Again");
			document.getElementById("statusimage").src="../images/tossagain.png";
		}
	}
	...
	function reset()
	{
		...
		document.getElementById("statusimage").src="../images/toss.png";
